##########################################
## Build and Train the ANN Model for LR ##
##########################################

## h2o Input data
h2o.init()
train.data.frame.h2o       <- as.h2o(subset(train.data.frame, select = c(-UREA_WATER_FLOW_CONTROL)))
test.data.frame.for.LR.h2o <- as.h2o(subset(test.data.frame.for.LR, select = c(-UREA_WATER_FLOW_CONTROL)))
...
as.data.frame(h2o.cbind(predicted.NOx.Emission.h2o$predict, test.data.frame.for.LR.h2o$FLUE_GAS_NOX))
...
test.FLUE_GAS_NOX       <- as.data.frame(as.numeric(test.data.frame.for.LR.h2o$FLUE_GAS_NOX))
